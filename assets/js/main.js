...
function actualizarLista() {
    ...
    nombres.forEach(nombre => {
        ...
        btnEliminar.setAttribute("title", "Quitar Canción");
        btnEliminar.textContent = "Quitar Canción";
        ...
        btnedit.setAttribute("title", "Editar Canción");
        btnedit.textContent = "Editar Canción";
